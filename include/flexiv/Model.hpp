...
public:
    /**
     * @brief Create a flexiv::Model instance and initialize the integrated dynamics engine.
     ...
     * @throw std::logic_error if the parsed robot model is not supported.
     */
    Model(
     ...
     * \f$. Unit: \f$ [rad/s] \f$.
     */
    void updateModel(const std::array<double, k_jointDOF>& positions,
